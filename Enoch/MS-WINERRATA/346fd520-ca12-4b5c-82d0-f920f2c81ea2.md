...
<table>
 ...
 <tr>
  ...
  interface on which all dial-up clients connect. For Ethernet and other
  broadcast interfaces, specify zero (0). Also specify zero (0) for
  ...
  *PIGMP_MIB_GROUP_SOURCE_INFO_V3;</p>
  ...
  <p> </p>
  <p>    DWORD       PS_LastPeerUpdateTickCount;</p>
  <p> </p>
  <p>    DWORD      
