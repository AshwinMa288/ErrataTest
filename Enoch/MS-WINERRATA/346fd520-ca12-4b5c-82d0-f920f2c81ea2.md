...
<table>
 <thead>
  <tr>
   ...
   <th>
   <p><img id="Picture 83" src="ms-winerrata_files/image001.png"><a href="http://blogs.msdn.com/b/protocol_content_errata/rss.aspx">RSS</a> </p>
   <p><img id="Picture 82" src="ms-winerrata_files/image001.png"><a href="http://blogs.msdn.com/b/protocol_content_errata/atom.aspx">Atom</a> </p>
   <p> </p>
   </th>
  </tr>
 </thead>
...
<p>Errata below are for Protocol Document Version <a href="https://docs.microsoft.com/en-us/openspecs/windows_protocols/ms-rrasm/a1e2840d-c9ff-4407-abf4-17aa6af34112">V23.0
– 2018/09/12</a>.</p>
...
<table>
 ...
 <tr>
  ...
  RAS client. The membership is summarized over the RAS clients unless the IGMP_ENUM_FOR_RAS_CLIENTS_ID
  flag is set in Flags.&#8203;</p>
  <p>...&#8203;</p>
  <p>&#8203;</p>
  <p>Changed to:&#8203;</p>
  <p>The IGMP_MIB_GROUP_INFO structure is used in the
  ...
  <p> </p>
  <p><img id="Picture 378" src="ms-winerrata_files/image016.png"></p>
  <p>&#8203;</p>
  <p>Changed to:&#8203;</p>
  <p>The IP_NAT_MIB_QUERY structure is used to retrieve
  Network Address Translator (NAT) information and is passed to the following
  ...
  of the following values.&#8203;</p>
  <p> </p>
  <p><img id="Picture 379" src="ms-winerrata_files/image017.png"></p>
  <p>&#8203;</p>
  ...
  <p>&#9679; MUST NOT have more than one modify Action
  clause with eAttrType in BGP_POLICY_MODIFY (section 2.2.1.2.258) set to NewLocalPref
  (0x3).&#8203;</p>
  <p>&#9679; MUST NOT have more than one modify Action
  clause with eAttrType in BGP_POLICY_MODIFY set to NewNextHop (0x4).&#8203;</p>
  <p>&#9679; MUST NOT have more than one modify Action
  ...
  <p>...&#8203;</p>
  <p>&#9679; If the RRAS server completes the processing
  successfully return either ERROR_SUCCESS or
  ERROR_SUCCESS_REBOOT_REQUIRED&lt;316&gt; based on the impact of the
  ...
  <p>...&#8203;</p>
  <p>&#9679; If the RRAS server completes the processing
  successfully, it MUST return either ERROR_SUCCESS, ERROR_SUCCESS_REBOOT_REQUIRED&lt;321&gt;,
  or ERROR_RESTART_REQUIRED&lt;322&gt; based on the impact of the configuration
  ...
  again call the API with GetDevConfig.size set to the size of returned GetDevConfig.size.&#8203;</p>
  <p>...&#8203;</p>
  <p>&#8203;</p>
  <p>Changed to:&#8203;</p>
  <p>...&#8203;</p>
  ...
  format; and also added section numbers to programming elements where
  applicable.&#8203;&#8203;&#8203;</p>
  <p>&#8203;&#8203;</p>
 ...
 <tr>
  ...
  <p> </p>
  <p>0x00000003   IPX Static Route Table. See
  IPX_STATIC_ROUTE_INFO (section 2.2.1.2.93).</p>
  <p> </p>
  <p>IPX_SERV_TABLE</p>
  <p> </p>
  <p>0x00000004   IPX service table. See IPX_SERVICE
  ...
  LastQuerierChangeTime description changed member name from igmpInterfaceQuerier
  to QuerierIpAddr.</p>
  <p> </p>
  <p>Changed from:</p>
  <p> </p>
  ...
  <p>    DWORD       Flags;</p>
  <p> </p>
  <p>} IGMP_MIB_GROUP_SOURCE_INFO_V3, *PIGMP_MIB_GROUP_SOURCE_INFO_V3;</p>
  <p> </p>
  ...
  <p>Changed from:</p>
  <p> </p>
  <p>NumSources: The number of entries of IGMP_MIB_GROUP_SOURCE_INFO_V3.</p>
  <p> </p>
