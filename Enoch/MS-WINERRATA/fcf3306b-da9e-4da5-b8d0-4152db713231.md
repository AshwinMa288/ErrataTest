...
    End   of decoding loop
 ...
 <tr>
  ...
  CurrentOutputPosition with OutputPosition for simplicity and clarity of the pseudocode.</p>
  <p> </p>
  <p>Changed from:</p>
  <p> </p>
  ...
  <p> </p>
  <p>    Output
  OutputBuffer[CurrentOutputPosition – MatchOffset + i]</p>
  <p> </p>
  <p>Changed to:</p>
  <p> </p>
  <p>For i = 0 to MatchLength - 1</p>
 ...
 <tr>
  ...
  <p> </p>
  <p>    Loop until a literal processing terminating
  condition</p>
  <p> </p>
  <p>Changed to:</p>
  <p> </p>
