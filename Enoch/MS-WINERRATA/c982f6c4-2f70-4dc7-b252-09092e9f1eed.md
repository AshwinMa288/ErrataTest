...
<table>
 ...
 <tr>
  ...
  AD-IF-RELEVANT containers for all other authorization data entries. The server
  MUST check if KERB-AD-RESTRICTION-ENTRY.Restriction.MachineID (section 2.2.6)
  is equal to machine ID (section 3.1.1.4):</p>
  <p> </p>
 ...
 <tr>
  ...
  (KRB_TGS_REQ)…</p>
  <p>&#9679;</p>
  <p>Kerberos ticket-granting service (TGS) response message
  (KRB_TGS_REP)…</p>
  <p> </p>
