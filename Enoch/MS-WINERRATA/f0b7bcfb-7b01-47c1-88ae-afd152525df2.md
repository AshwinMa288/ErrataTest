...
<table>
 ...
 <tr>
  ...
  Connection.useCount</p>
  <p>&#9679;          ui2_domainname set to Connection.domain</p>
  ...
  server MUST return the information about the connection by filling the USE_INFO_2_CONTAINER
  (section 2.2.5.27) structure in the Buffer field of the InfoStruct parameter
  as follows. USE_INFO_2_CONTAINER contains an array of USE_INFO_2 structures.</p>
  <p>&#9679;          ui2_local set to Connection.local</p>
  <p>&#9679;          ui2_remote set to Connection.remote</p>
  <p>&#9679;          ui2_password set to NULL</p>
  <p>&#9679;          ui2_status set to Connection.status</p>
