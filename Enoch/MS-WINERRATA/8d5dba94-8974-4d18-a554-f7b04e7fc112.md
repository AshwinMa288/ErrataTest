...
   
 ...
 <tr>
  ...
  <table>
   ...
   <tr>
    <td>
    <p>pwszNodePath is &quot;PolicyModules\CertificateAuthority_MicrosoftDefault.Policy&quot;
    and pwszEntry is &quot;RequestDisposition&quot;</p>
    </td>
    <td>
    <p>The CA MUST return the value of the
  ...
  <table>
   ...
   <tr>
    <td>
    <p>pwszNodePath is EMPTY and pwszEntry is &quot;CACertPublicationURLs&quot;</p>
    </td>
    <td>
    <p>OnNextRestart_Config_CA_AIA_Include_In_Cert<br><br></p>
    <p>OnNextRestart_Config_CA_CACert_Publish_To</p>
 ...
 <tr>
  ...
  [MS-DTYP] section 2.4.4.6), or the AceType 0x0A (ACCESS_DENIED_CALLBACK_ACE_TYPE
  for the ACCESS_DENIED_CALLBACK_ACE, [MS-DTYP] section 2.4.4.7).&quot;</p>
  <p> </p>
  <p> &#8203;</p>
  <table>
   <thead>
 ...
 <tr>
  ...
  <p> </p>
  <p>…</p>
  <p>8.   For each input in the left column of the table below,
  the CA MUST perform the processing rules in the corresponding cell in the
  right column.</p>
  <p> </p>
  <table>
   <thead>
