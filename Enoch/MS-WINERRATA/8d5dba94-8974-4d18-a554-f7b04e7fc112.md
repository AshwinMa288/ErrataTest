...
<table>
 ...
 <tr>
  ...
  &quot;SetupStatus&quot;&#8203;</p>
  <p> </p>
  <p>pwszNodePath is EMPTY and pwszEntry is &quot;Version&quot;&#8203;</p>
  <p> </p>
  <p>Changed to:</p>
  <p> </p>
  ...
  is &quot;SetupStatus&quot;.</p>
  <p> </p>
  <p>pwszAuthority is EMPTY andpwszNodePath is EMPTY and
  pwszEntry is &quot;Version&quot;</p>
  <p>Changed from:</p>
  <p> </p>
  <dl>
...
   
  ...
  <p> c0 d6 3f 26 0e 2c b5 93 dd 26 d5 4b 84 a1 1d 2a</p>
  </td>
 </tr>
 <tr>
  <td>
  ...
  <table>
   ...
   <tr>
    ...
    <td>
    <p>The CA MUST return the value of the OnNextRestart_Config_CA_OCSP_Include_In_Cert
    ADM element as a VARIANT.<br><br></p>
    <p>The vt member of the VARIANT MUST be set to VT_ARRAY
    | VT_BSTR and the pArray member MUST reference a single dimension
    safearray.<br><br></p>
    <p>The number of elements of the safearray referenced
 ...
 <tr>
  ...
  <td>
  <p>In Section 2.2.1.11, added the optional ACCESS_DENIED_CALLBACK_ACE
  type for all access control entries (ACEs) in the discretionary access
  control list (DACL), as a security descriptor property for Officer rights and
  Enrollment Agent rights.</p>
  <p>&#8203;</p>
  <p>Changed from:</p>
  <p> </p>
 ...
 <tr>
  ...
  <p> </p>
  <p> </p>
  <p>In Section 7, Appendix B: Product Behavior, changed from:</p>
  <p> </p>
