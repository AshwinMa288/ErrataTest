...
  52   4f 44 45 4e 54 00 -&gt; ClientMachineName::blobData
 ...
 <tr>
  ...
  section 2.2.1.12.1.3 can be used by both client and server.</p>
  <p> </p>
  <p>In Section 3.1.5.2 Sending Licensing Error Messages, changed
  from:</p>
  <p> </p>
  ...
  ERR_INVALID_SERVER_CERTIFICATE (0x01) and a state transition of ST_TOTAL_ABORT
  (0x01). The server MUST then end the licensing protocol.</p>
  <p>&#9679;The client searches its license store to find a
