 ...
 <tr>
  ...
  <table>
   ...
   <tr>
    ...
    <td>
    <p>A Device Removed Notification (section 2.2.2.4) message.&#8203;</p>
    </td>
   </tr>
   <tr>
    <td>
   ...
   <tr>
    ...
    <td>
    <p>A Stream List Request (section 2.2.3.5) message.&#8203;</p>
    </td>
   </tr>
   <tr>
    <td>
  ...
  <table>
   ...
   <tr>
    ...
    <td>
    <p>I420 video. &#8203;Identical to YV12 as described in
    [MSDN-YUVFormats] except that the order of the U and V planes is reversed.&#8203;</p>
    </td>
   </tr>
   <tr>
    <td>
