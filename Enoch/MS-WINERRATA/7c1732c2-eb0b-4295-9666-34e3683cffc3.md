...
<table>
 ...
 <tr>
  ...
  <table>
   ...
   <tr>
    ...
    <td>
    <p>The zone type. See dwZoneType (section 2.2.5.2.4.1). 
    Default: DNS_ZONE_TYPE_PRIMARY</p>
    </td>
   </tr>
   <tr>
    <td>
 ...
 <tr>
  ...
  DnsPolicyCriteriaEDNSSubnet is not implemented in Windows Server v1809 operating
  system and earlier.&#8203;</p>
  <p>&#8203;</p>
  <p>Changed to:</p>
  <p> </p>
  <p>DnsPolicyCriteriaEDNSSubnet:  Usage of this enum
