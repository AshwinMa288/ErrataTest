...
<table>
 ...
 <tr>
  ...
  default values are assigned to Data. See Property Id (section 2.3.2.1.1).</p>
  <p> </p>
  <p>In Section 2.3.2.1.1, Property Id, added to introduction
  the case for when DataLength field is zero default values are used. Added
  default values in the ID table.</p>
  <p> </p>
  <p>Changed from:</p>
