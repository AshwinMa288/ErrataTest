...
<table>
 ...
 <tr>
  ...
  PropID = 0x0000001D property in the GetCAProperty method, consisting of a
  string containing pairs of the template name and OID separated by new lines.</p>
  <p>&#8203;</p>
  <p>Changed from:</p>
  <p> </p>
 ...
 <tr>
  ...
  <td>
  <p>In Section 3.1.2.4.2.2.2.8 ,
  Certificate.Template.msPKI-Private-Key-Flag, added missing
  'CT_FLAG_HELLO_LOGON_KEY' flag and description to the processing rules table.
  Also added new informative reference [MSDOCS-WHfB] to the  description for
  the missing flag</p>
  <p> </p>
  <p> </p>
  <p>Changed from:&#8203;</p>
