...
  ea   03 -&gt;TS_SYNCHRONIZE_PDU::targetUser = 0x03ea
 ...
 <tr>
  ...
  annotated dump – pad1octet to drawingFlags &amp; pad2octetsB to
  orderSupportExFlags.</p>
  <p> </p>
  <p>Changed from:</p>
  <p> </p>
  <dl>
...
  32   00 -&gt; TS_FONT_LIST_PDU::entrySize = 0x0032 = 50 bytes
  ...
  <p> </p>
  <p>In Section 4.4, Annotated Server-to-Client Virtual Channel
  PUD, revised HEADER to HEADER1.</p>
  <p> </p>
  <p>Changed from:</p>
  <p> </p>
  <dl>
...
  c0   d6 3f 26 0e 2c b5 93 dd 26 d5 4b 84 a1 1d 2a
 ...
 <tr>
  ...
  <td>
  <p>In Section 5.4.2.2, Direct Approach, revised the figure.</p>
  <p> </p>
  <p>Changed from:</p>
  ...
  the X.224 messages which form the Connection Initiation phase (section 1.3.1.1);
  or (b) the Early User Authorization Result PDU (section 2.2.10.2) followed by
  the X.224 messages. From this point all RDP traffic is encrypted using the
  CredSSP External Security Protocol.</p>
