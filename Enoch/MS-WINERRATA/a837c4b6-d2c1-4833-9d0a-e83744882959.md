 ...
 <tr>
  ...
  <table>
   ...
   <tr>
    ...
    being displayed by Winlogon. The session identifier is specified by the ErrorNotificationData
    field.<br><br></p>
    <p> </p>
    </td>
   </tr>
...
  00   84 03 00 -&gt; TS_ORDER_CAPABILITYSET::desktopSaveSize = 0x38400 = 230400
  ...
  annotated dump – numberEntries to numberFonts &amp; totalNumEntries to totalNumFonts
  &amp; added a couple of lines.</p>
  <p> </p>
  <p>Changed from:</p>
  <p> </p>
  <dl>
