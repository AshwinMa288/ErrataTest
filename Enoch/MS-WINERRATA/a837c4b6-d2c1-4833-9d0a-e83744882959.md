...
  c0   d6 3f 26 0e 2c b5 93 dd 26 d5 4b 84 a1 1d 2a
 ...
 <tr>
  ...
  protocol handshake has completed successfully, the RDP Connection Sequence begins,
  starting with the X.224 messages which form the Connection Initiation phase
  (section 1.3.1.1). From this point all RDP traffic is encrypted using the
