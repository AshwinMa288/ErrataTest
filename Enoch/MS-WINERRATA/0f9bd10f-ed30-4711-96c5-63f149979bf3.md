...
<table>
 ...
 <tr>
  ...
  <p>Changed to:&#8203;</p>
  <p>...&#8203;</p>
  <p>6.   The RDG server decrypts the packet received with DTLS.
  The RDG server decodes the message and verifies the signature on the decoded
  message. The RDG server maps the decoded message to the AUTHN_COOKIE_DATA
  structure.&#8203;</p>
  <p>&#8203;</p>
  <p>7.  The RDG server connects to the target server
