...
<table>
 ...
 <tr>
  ...
  different directory the client will receive this notification along with FILE_ACTION_REMOVED.</p>
  <p> </p>
  <p>FILE_ACTION_RENAMED_OLD_NAME</p>
  <p> </p>
  <p>0x00000004   The file was renamed, and this is the old
  name. This notification is only sent when the rename operation does not
  change the directory the file resides in. The client will also receive a FILE_ACTION_RENAMED_NEW_NAME
  notification. This notification will not be received if the file is renamed
